...
var current="The new UI is here! Hang tight!";        //—>enter what you want the script to display when the target date and time are reached, limit to 20 characters
...
var minute=1;        //—>Enter the count down target date MINUTE
